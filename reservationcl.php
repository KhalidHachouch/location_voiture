  ...
  <tr style="background-color: gold;">
      ...
      <th scope="col">action</th>
       ...
       <form action="annuler.php" method="get">
                 <tr>  <?php $date=date('Y-m-d'); $sql = mysqli_query($con, "SELECT r.* ,v.*  FROM reservation r,voiture v where r.matricule=v.matricule and r.cin='$cin' and r.date_debut> '$date' ");
  while($data = mysqli_fetch_assoc($sql)){ 
   
    ?> 
            <td  name="num" ><?php echo $data['numero_reservation']; ?></td>
            ...
            <td> <a name="annuler"  href="annuler.php?numero_reservation=<?php echo $data['numero_reservation'] ; ?>" onclick=" return confirm('etes vous sur de vouloir annuler');" class="btn btn-danger btn-sm active" role="button" aria-pressed="true">Annuler</a</td>
